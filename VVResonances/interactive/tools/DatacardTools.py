...
class DatacardTools():
 ...
 def __init__(self,scales,scalesHiggs,tagger_pt_dependence,PU_unc,JES_unc,JER_unc,lumi_unc,PDF_unc,sfQCD,pseudodata,outlabel,doCorrelation=True,fitvjetsmjj=False,doKfactors=False,sfVjets=1):
