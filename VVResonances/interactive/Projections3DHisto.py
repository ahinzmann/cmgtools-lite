...
for i in range(4):
 ...
 hx[i].SetLineWidth(2)
 hxMC[i].SetLineWidth(2)
 hy[i].SetLineWidth(2)
 hyMC[i].SetLineWidth(2)
...
hz_PTUp.SetLineStyle(3)
hz_PTUp.SetLineWidth(2)
...
hz_PTDown.SetLineStyle(3)
hz_PTDown.SetLineWidth(2)
...
hz_altshapeUp.SetLineWidth(2)
hz_altshapeUp.SetLineStyle(2)
...
hz_altshapeDown.SetLineWidth(2)
hz_altshapeDown.SetLineStyle(2)
...
hz_altshape2Down.SetLineWidth(2)
...
hx_PTUp.SetLineWidth(2)
hx_PTUp.SetLineStyle(3)
...
hx_PTDown.SetLineWidth(2)
hx_PTDown.SetLineStyle(3)
...
hx_altshapeUp.SetLineWidth(2)
hx_altshapeUp.SetLineStyle(2)
...
hx_altshapeDown.SetLineWidth(2)
hx_altshapeDown.SetLineStyle(2)
...
hx_altshape2Down.SetLineWidth(2)
...
hx[0].GetXaxis().SetNdivisions(505)
hx[0].GetXaxis().SetLabelSize(0.05)
hx[0].GetYaxis().SetTitleSize(0.05)
hx[0].GetYaxis().SetTitleOffset(1.5)
...
hy_PTUp.SetLineWidth(2)
hy_PTUp.SetLineStyle(3)
...
hy_PTDown.SetLineWidth(2)
hy_PTDown.SetLineStyle(3)
...
hy_altshapeUp.SetLineWidth(2)
hy_altshapeUp.SetLineStyle(2)
...
hy_altshapeDown.SetLineWidth(2)
hy_altshapeDown.SetLineStyle(2)
...
hy_altshape2Down.SetLineWidth(2)
...
hy[0].GetXaxis().SetNdivisions(505)
hy[0].GetYaxis().SetTitleSize(0.05)
hy[0].GetYaxis().SetTitleOffset(1.5)
